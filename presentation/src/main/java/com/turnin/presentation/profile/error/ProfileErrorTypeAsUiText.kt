package com.turnin.presentation.profile.error
...
internal fun ProfileErrorType.asUiText(): UiText = when (this) {
    ...
    ProfileErrorType.FriendNotFound -> StringResource(R.string.profile_error_friend_not_found)
    ProfileErrorType.MissingUnblockTarget -> StringResource(R.string.profile_error_missing_unblock_target)
