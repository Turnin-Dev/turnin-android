...
class NotificationSyncManagerTest {
    private val notificationPermissionManager: com.turnin.app.util.notification.NotificationPermissionManager = mockk()
    private val notificationRepository: NotificationRepository = mockk()
    private val settingRepository: SettingRepository = mockk()
    private lateinit var syncManager: com.turnin.app.util.notification.NotificationSyncManagerImpl
    ...
    private fun createSyncManager() {
        syncManager = _root_ide_package_.com.turnin.app.util.notification.NotificationSyncManagerImpl(
