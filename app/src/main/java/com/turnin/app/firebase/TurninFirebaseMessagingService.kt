...
@AndroidEntryPoint
class TurninFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun showNotification(
        ...
        val channelId = TurninNotificationChannel.getChannelId(notiType)
        val channelName = when (channelId) {
            TurninNotificationChannel.HIGH_ID -> getString(
        ...
        val importance = when (channelId) {
            TurninNotificationChannel.HIGH_ID -> NotificationManager.IMPORTANCE_HIGH
        ...
        val priority = when (channelId) {
            TurninNotificationChannel.HIGH_ID -> NotificationCompat.PRIORITY_HIGH
