...
import com.turnin.app.R
import com.turnin.core.common.coroutine.ApplicationScope
import com.turnin.core.common.coroutine.IO
import com.turnin.core.common.fcm.FcmDataKey
...
class PeekrFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun showNotification(
        ...
        val channelId = _root_ide_package_.com.turnin.app.firebase.PeekrNotificationChannel.getChannelId(notiType)
        val channelName = when (channelId) {
            _root_ide_package_.com.turnin.app.firebase.PeekrNotificationChannel.HIGH_ID -> getString(
                R.string.notification_channel_high_name,
            )
            else -> getString(R.string.notification_channel_normal_name)
        }
        val importance = when (channelId) {
            _root_ide_package_.com.turnin.app.firebase.PeekrNotificationChannel.HIGH_ID -> NotificationManager.IMPORTANCE_HIGH
        ...
        val priority = when (channelId) {
            _root_ide_package_.com.turnin.app.firebase.PeekrNotificationChannel.HIGH_ID -> NotificationCompat.PRIORITY_HIGH
