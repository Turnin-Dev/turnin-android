...
import com.peekr.data.common.util.crypto.DecryptException
import com.peekr.domain.common.dataStore.DataStoreKey
import com.peekr.domain.common.dataStore.DataStoreManager
import com.peekr.domain.common.dataStore.WritingDataException
...
class DataStoreManagerImplTest {
    ...
    fun `암호화된 데이터를 가져올 때 - 복호화 실패 시 DecryptException 예외가 발생한다`() = runTest {
        ...
        assertTrue(exception is com.peekr.domain.common.dataStore.DecryptException)
    }
