...
private fun CoreTextField(
    ...
    val colorScheme = TurninTheme.colorScheme
    ...
    BasicTextField(
        ...
        textStyle = TurninTheme.typography.body1.copy(
            color = color,
        ...
        Column(
            ...
            Box(contentAlignment = Alignment.CenterStart) {
                if (text.isEmpty()) {
                    Text(
                        text = placeholder,
                        style = TurninTheme.typography.body1.copy(fontWeight = FontWeight.Medium),
 ...
 */
@Composable
fun TurninSupportingText(
    text: String,
    color: Color = TurninTheme.colorScheme.textNormal,
    maxLines: Int = 2,
) {
    Text(
        text = text,
...
@Composable
private fun TurninTextFieldPreview() {
