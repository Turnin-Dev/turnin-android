 ...
 * [TurninMenu]와 함께 사용
 *
 * @param menuItemType 메뉴 아이템 타입 ([TurninMenuItemType])
...
@Composable
fun TurninMenuItem(
    menuItemType: TurninMenuItemType,
    text: String,
    ...
    Box(
        ...
        Text(
            ...
            color = when (menuItemType) {
                TurninMenuItemType.Positive -> TurninTheme.colorScheme.textNormal
                TurninMenuItemType.Negative -> TurninTheme.colorScheme.statusNegative
            },
        )
    }
}
