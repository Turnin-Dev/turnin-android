...
import com.peekr.core.presentation.util.UiText.DynamicString
...
fun ErrorType.asUiText(): UiText = when (this) {
    ...
    ErrorType.Network.UploadFileFailed -> StringResource(R.string.error_network_upload_file_failed)
    // ------------------------------ Unexpected ------------------------------
