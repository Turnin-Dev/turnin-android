...
interface DataStoreManager {
     ...
     *
     * @param key DataStore 키
     * @throws IllegalArgumentException 유효하지 않은 키가 전달될 때 발생
     */
